...
export const initialBooks: Book[] = [
    ...
    },
    {
        ...
        pages: 528,
        status: "LENDO",
        synopsis: "Trinta anos depois de se conhecerem, Adrien, Étienne e Nina se tornaram estranhos uns para os outros. A amizade que eles juraram que seria eterna não existe mais. Porém, um acontecimento inesperado pode trazer à tona segredos enterrados há muito tempo.",
    },
    {
        id: "3",
        title: "A empregada",
